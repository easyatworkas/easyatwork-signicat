...
class Authentication extends AbstractStructBase
{
     ...
     * @param bool $artifact
     */
    public function __construct(\Easyatwork\Signicat\StructType\Dialog $dialog = null, array $method = array(), $artifact = null)
    {
        $this
            ->setDialog($dialog)
            ->setMethod($method)
     ...
     * Set dialog value
     * @param \Easyatwork\Signicat\StructType\Dialog $dialog
     * @return \Easyatwork\Signicat\StructType\Authentication
     */
    ...
    public function setArtifact($artifact = null)
    {
        ...
        if (!is_null($artifact) && !is_bool($artifact)) {
            throw new \InvalidArgumentException(sprintf('Invalid value, please provide a bool, "%s" given', gettype($artifact)), __LINE__);
        }
