...
class Task_filter_criteria extends AbstractStructBase
{
     ...
     * @param string $field
     * @return \Easyatwork\Signicat\StructType\Task_filter_criteria
     */
    public function setField($field = null)
    {
        // validation for constraint: enumeration
        if (!\Easyatwork\Signicat\EnumType\Task_filter_field::valueIsValid($field)) {
            throw new \InvalidArgumentException(sprintf('Value "%s" is invalid, please use one of: %s', $field, implode(', ', \Easyatwork\Signicat\EnumType\Task_filter_field::getValidValues())), __LINE__);
        }
        $this->field = $field;
        return $this;
    }
    ...
    /**
     * Set operator value
     * @uses \Easyatwork\Signicat\EnumType\Logical_operator::valueIsValid()
     * @uses \Easyatwork\Signicat\EnumType\Logical_operator::getValidValues()
     * @throws \InvalidArgumentException
     * @param string $operator
     * @return \Easyatwork\Signicat\StructType\Task_filter_criteria
     */
    ...
    {
        // validation for constraint: enumeration
        if (!\Easyatwork\Signicat\EnumType\Logical_operator::valueIsValid($operator)) {
            throw new \InvalidArgumentException(sprintf('Value "%s" is invalid, please use one of: %s', $operator, implode(', ', \Easyatwork\Signicat\EnumType\Logical_operator::getValidValues())), __LINE__);
        }
    ...
    public function setCase_sensitive($case_sensitive = true)
    {
        ...
        if (!is_null($case_sensitive) && !is_bool($case_sensitive)) {
            throw new \InvalidArgumentException(sprintf('Invalid value, please provide a bool, "%s" given', gettype($case_sensitive)), __LINE__);
        }
