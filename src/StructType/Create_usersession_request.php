...
class Create_usersession_request extends AbstractStructBase
{
    ...
    /**
     * The user_session
     * @var \Easyatwork\Signicat\StructType\User_session
     */
    public $user_session;
    /**
     ...
     * @param \Easyatwork\Signicat\StructType\User_session $user_session
     */
    public function __construct($service = null, $password = null, \Easyatwork\Signicat\StructType\User_session $user_session = null)
    {
        $this
            ->setService($service)
     ...
     * Set service value
     * @param string $service
     * @return \Easyatwork\Signicat\StructType\Create_usersession_request
     */
     ...
     * @return \Easyatwork\Signicat\StructType\User_session|null
     */
     ...
     * @return \Easyatwork\Signicat\StructType\Create_usersession_request
     */
    public function setUser_session(\Easyatwork\Signicat\StructType\User_session $user_session = null)
    {
