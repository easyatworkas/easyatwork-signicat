...
class Method extends AbstractStructBase
{
     ...
     * Set _ value
     * @param string $_
     * @return \Easyatwork\Signicat\StructType\Method
     */
    ...
    public function setHandwritten($handwritten = null)
    {
        ...
        if (!is_null($handwritten) && !is_bool($handwritten)) {
            throw new \InvalidArgumentException(sprintf('Invalid value, please provide a bool, "%s" given', gettype($handwritten)), __LINE__);
        }
