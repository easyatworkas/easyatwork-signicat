...
class Add_task_request extends AbstractStructBase
{
     ...
     */
    public function __construct($service = null, $password = null, $request_id = null, \Easyatwork\Signicat\StructType\Task $task = null)
    {
        $this
            ->setService($service)
     ...
     * Set service value
     * @param string $service
     * @return \Easyatwork\Signicat\StructType\Add_task_request
     */
