...
class Document_status extends AbstractStructBase
{
     ...
     * - maxOccurs: unbounded
     * - minOccurs: 0
     * @var \Easyatwork\Signicat\StructType\Form_param[]
     */
     ...
     * @param \Easyatwork\Signicat\StructType\Form_param[] $form_output_param
     */
     ...
     * Set id value
     * @param string $id
     * @return \Easyatwork\Signicat\StructType\Document_status
     */
     ...
     * @return \Easyatwork\Signicat\StructType\Form_param[]|null
     */
    ...
    public function setForm_output_param(array $form_output_param = array())
    {
        foreach ($form_output_param as $document_statusForm_output_paramItem) {
            ...
            if (!$document_statusForm_output_paramItem instanceof \Easyatwork\Signicat\StructType\Form_param) {
                throw new \InvalidArgumentException(sprintf('The form_output_param property can only contain items of \Easyatwork\Signicat\StructType\Form_param, "%s" given', is_object($document_statusForm_output_paramItem) ? get_class($document_statusForm_output_paramItem) : gettype($document_statusForm_output_paramItem)), __LINE__);
            }
        }
    ...
    /**
     */
    public function addToForm_output_param(\Easyatwork\Signicat\StructType\Form_param $item)
    {
        // validation for constraint: itemType
        if (!$item instanceof \Easyatwork\Signicat\StructType\Form_param) {
            throw new \InvalidArgumentException(sprintf('The form_output_param property can only contain items of \Easyatwork\Signicat\StructType\Form_param, "%s" given', is_object($item) ? get_class($item) : gettype($item)), __LINE__);
        }
