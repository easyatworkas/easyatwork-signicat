...
class Subject extends AbstractStructBase
{
     ...
     * - minOccurs: 0
     * - nillable: true
     * @var \Easyatwork\Signicat\StructType\Attribute[]
     */
    public $attribute;
    /**
     * The id
     ...
     * @param \Easyatwork\Signicat\StructType\Attribute[] $attribute
     * @param string $id
     */
     ...
     * @param string $national_id
     * @return \Easyatwork\Signicat\StructType\Subject
     */
     ...
     * @return \Easyatwork\Signicat\StructType\Attribute[]|null
     */
    ...
    public function setAttribute(array $attribute = array())
    {
        foreach ($attribute as $subjectAttributeItem) {
            ...
            if (!$subjectAttributeItem instanceof \Easyatwork\Signicat\StructType\Attribute) {
                throw new \InvalidArgumentException(sprintf('The attribute property can only contain items of \Easyatwork\Signicat\StructType\Attribute, "%s" given', is_object($subjectAttributeItem) ? get_class($subjectAttributeItem) : gettype($subjectAttributeItem)), __LINE__);
            }
        }
     ...
     * @throws \InvalidArgumentException
     * @param \Easyatwork\Signicat\StructType\Attribute $item
     * @return \Easyatwork\Signicat\StructType\Subject
     */
    public function addToAttribute(\Easyatwork\Signicat\StructType\Attribute $item)
    {
        // validation for constraint: itemType
        if (!$item instanceof \Easyatwork\Signicat\StructType\Attribute) {
            throw new \InvalidArgumentException(sprintf('The attribute property can only contain items of \Easyatwork\Signicat\StructType\Attribute, "%s" given', is_object($item) ? get_class($item) : gettype($item)), __LINE__);
        }
        $this->attribute[] = $item;
        return $this;
    }
